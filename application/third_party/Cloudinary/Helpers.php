...
namespace {
    ...
    function cl_image_tag($source, $options = array()) {
        $source = cloudinary_url_backoffice($source, $options);
    ...
    function cloudinary_url($source, $options = array()) {
        return cloudinary_url_backoffice($source, $options);
    }
    function cloudinary_url_backoffice($source, &$options = array()) {
    ...
    function cl_sprite_url($tag, $options = array()) {
        ...
        $options["type"] = "sprite";
        return cloudinary_url_backoffice($tag, $options);
    }
    ...
    function cl_video_tag($source, $options = array()) {
        ...
        if (array_key_exists('poster', $video_options)) {
            if (is_array($video_options['poster'])) {
                if (array_key_exists('public_id', $video_options['poster'])) {
                    $video_options['poster'] = cloudinary_url_backoffice($video_options['poster']['public_id'], $video_options['poster']);
                } else {
        ...
        $src = cloudinary_url_backoffice($source, $video_options);
