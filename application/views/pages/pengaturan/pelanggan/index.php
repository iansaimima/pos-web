                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h1 class="card-title">Daftar Pelanggan</h1>
                                <div class="card-tools">
                                    <?php
                                    // jika boleh create
                                    if ($allow_create) {
                                    ?>
                                        <button type="button" class="btn btn-xs btn-primary" onclick="load_detail('')"><i class="fa fa-plus"></i> Tambah</button>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><span id="modal-pelanggan-title"></span> Pelanggan</h5>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/pelanggan/ajax_list') ?>",
                    "type": "GET",
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/pelanggan/ajax_detail") ?>/' + uuid, {},
                function(resp) {
        ...
        function confirm_delete(uuid) {
            ...
            ajax_get(
                '<?= base_url("admin/pelanggan/ajax_delete") ?>/' + uuid, {},
                function(resp) {
                    try {
