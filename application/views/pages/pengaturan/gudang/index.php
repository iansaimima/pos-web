                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h1 class="card-title">Daftar Gudang</h1>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><span id="modal-gudang-title"></span> Gudang</h5>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/gudang/ajax_list') ?>",
                    "type": "GET",
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/gudang/ajax_detail") ?>/' + uuid, {},
                function(resp) {
        ...
        function confirm_delete(uuid) {
            ...
            ajax_get(
                '<?= base_url("admin/gudang/ajax_delete") ?>/' + uuid, {},
                function(resp) {
                    try {
