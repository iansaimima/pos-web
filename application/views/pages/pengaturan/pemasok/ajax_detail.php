...
?>
<form class="form-horizontal" onsubmit="return false;" id="form-pemasok-detail">
...
<script>
    $(document).ready(function() {
        $("#modal-pemasok-title").html('<?= $title ?>');
    });

    function save() {
        var form_data = $("#form-pemasok-detail").serializeArray();
        ajax_post(
            '<?= base_url("admin/pemasok/ajax_save") ?>',
            form_data,
            function(resp) {
                try {
