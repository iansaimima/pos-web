                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h5 class="card-title">Daftar Kategori Item</h5>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><span id="modal-item-kategori-title"></span> Kategori Item</h5>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/item_kategori/ajax_list') ?>",
                    "type": "GET",
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/item_kategori/ajax_detail") ?>/' + uuid, {},
                function(resp) {
        ...
        function confirm_delete(uuid) {
            ...
            ajax_get(
                '<?= base_url("admin/item_kategori/ajax_delete") ?>/' + uuid, {},
                function(resp) {
                    try {
