...
$allow_create = isset($privilege_list["allow_stock_opname_create"]) ? $privilege_list["allow_stock_opname_create"] : 0;
$allow_update = isset($privilege_list["allow_stock_opname_update"]) ? $privilege_list["allow_stock_opname_update"] : 0;
$allow_delete = isset($privilege_list["allow_stock_opname_delete"]) ? $privilege_list["allow_stock_opname_delete"] : 0;
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h5 class="card-title">Daftar Stock Opname</h5>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function initTable() {
            ...
            if (!$.fn.DataTable.isDataTable("#datatable")) {
                table = $("#datatable").DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url($uri_1 . '/stock_opname/ajax_list') ?>/" + gudangUuid,
                        "type": "GET",
                ...
                table.ajax.url("<?= base_url($uri_1 . '/stock_opname/ajax_list') ?>/" + gudangUuid).draw('page');
            }
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/stock_opname/ajax_detail") ?>/' + uuid, {},
                function(resp) {
