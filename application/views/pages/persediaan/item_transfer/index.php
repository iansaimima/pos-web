...
$allow_create = isset($privilege_list["allow_item_transfer_create"]) ? $privilege_list["allow_item_transfer_create"] : 0;
$allow_update = isset($privilege_list["allow_item_transfer_update"]) ? $privilege_list["allow_item_transfer_update"] : 0;
$allow_delete = isset($privilege_list["allow_item_transfer_delete"]) ? $privilege_list["allow_item_transfer_delete"] : 0;
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h5 class="card-title">Daftar Item Transfer</h5>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function initTable() {
            ...
            if (!$.fn.DataTable.isDataTable("#datatable")) {
                table = $("#datatable").DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url($uri_1 . '/item_transfer/ajax_list') ?>/" + gudangUuid,
                        "type": "GET",
                ...
                table.ajax.url("<?= base_url($uri_1 . '/item_transfer/ajax_list') ?>/" + gudangUuid).draw('page');
            }
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/item_transfer/ajax_detail") ?>/' + uuid, {},
                function(resp) {
