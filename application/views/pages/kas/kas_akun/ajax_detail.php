...
?>
<form class="form-horizontal" onsubmit="return false;" id="form-kas-akun-detail">
...
<script>
    $(document).ready(function() {
        $("#modal-kas-akun-title").html('<?= $title ?>');
    });

    function save() {
        var form_data = $("#form-kas-akun-detail").serializeArray();
        ajax_post(
            '<?= base_url("admin/kas_akun/ajax_save") ?>',
            form_data,
            function(resp) {
                try {
