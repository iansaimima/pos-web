                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text" style="text-align: right;">
                            <h4>Saldo : Rp. <?= isset($saldo_saat_ini) ? number_format($saldo_saat_ini, 0, ",", ".") : 0 ?></h4>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h1 class="card-title">Daftar Alur Kas</h1>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><span id="modal-kas-akun-title"></span> Alur Kas</h5>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/kas_alur/ajax_list') ?>",
                    "type": "GET",
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/kas_alur/ajax_detail") ?>/' + uuid, {},
                function(resp) {
        ...
        function confirm_delete(uuid) {
            ...
            ajax_get(
                '<?= base_url("admin/kas_alur/ajax_delete") ?>/' + uuid, {},
                function(resp) {
                    try {
