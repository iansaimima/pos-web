...
if (!$allow_laporan_item_transfer) {
          ...
          <tr>
            <td>
              <table>          
                ...
                <tr>
                    <td width="100">Keluar dari : </td>
                    <td align="left">' . $filters["dari_gudang_nama"] . '</td>
                </tr>
                <tr>
                    <td width="100">Masuk ke : </td>
                    <td align="left">' . $filters["ke_gudang_nama"] . '</td>
                </tr>
              </table>
            </td>
          </tr>
...
$pdf->Output("$judul Periode " . $filters["start_date"] . " sd " . $filters["end_date"] . " | dari " . $filters["dari_gudang_nama"]. " ke " . $filters["ke_gudang_nama"] . ".pdf", 'I');
