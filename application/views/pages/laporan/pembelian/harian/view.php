...
if (!$allow_laporan_pembelian_harian) {
  ...
  <table class="table table-bordered" cellspacing="1" style="background-color: #333; border: 0px solid #000">
      <thead>
          <tr style="background-color: #fff">
              ...
              <th style="text-align: right;padding: 2px 5px;">Jumlah Transaksi</th>
              <th style="text-align: right;padding: 2px 5px;">Total Transaksi</th>
          </tr>
      </thead>
      <tbody>');
...
foreach ($body as $l) {
    $pdf->WriteHTML('
          <tr style="background-color: #fff">
              ...
              <td style="padding: 2px 5px; width: 180px; text-align: right">' . $l["jumlah_transaksi"] . '</td>
              <td style="padding: 2px 5px; width: 180px; text-align: right">' . $l["total_transaksi"] . '</td>
          </tr>
        ');
...
$pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 4px 5px;" colspan="3"></td>
          </tr>
        ');
