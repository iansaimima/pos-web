                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body pt-0" style="margin: 0">
                                <form onsubmit="return false" class="form-horizontal" id="form-pembelian-harian-report">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header border-0 pb-1">
                                <h1 class="card-title"><span id="judul-laporan">Laporan Pembelian Harian</span></h1>
                            </div>
                            <div class="card-body p-3 pt-3" style="margin: 0">
                                <iframe class="iframe-rounded" id="frame-pembelian-harian-report" src="about:blank" frameborder="0" style="width: 100%; height: calc(100vh - 210px)"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function setJudulLaporan(title) {
            if (title == "summary") $("#judul-laporan").html("Laporan harian pembelian");
            if (title == "harian") $("#judul-laporan").html("Laporan harian pembelian");
        }
        ...
        function showReport() {
            ...
            // load report
            $("#frame-pembelian-harian-report").attr('src', "<?= base_url("admin/laporan/pembelian/harian_view") ?>?" + params.join("&"));

            // hilangkan progress bar ketika laporan telah selesai di-load
            $("#frame-pembelian-harian-report").on("load", function() {
                $("#loader").hide();
            });
        }
    </script>
