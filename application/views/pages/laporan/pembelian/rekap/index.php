                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body pt-0" style="margin: 0">
                                <form onsubmit="return false" class="form-horizontal" id="form-pembelian-rekap-report">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header border-0 pb-1">
                                <h1 class="card-title"><span id="judul-laporan">Laporan Pembelian Rekap</span></h1>
                            </div>
                            <div class="card-body p-3 pt-3" style="margin: 0">
                                <iframe class="iframe-rounded" id="frame-pembelian-rekap-report" src="about:blank" frameborder="0" style="width: 100%; height: calc(100vh - 210px)"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function setJudulLaporan(title) {
            if (title == "summary") $("#judul-laporan").html("Laporan Rekap pembelian");
        ...
        function showReport() {
            ...
            // load report
            $("#frame-pembelian-rekap-report").attr('src', "<?= base_url("admin/laporan/pembelian/rekap_view") ?>?" + params.join("&"));

            // hilangkan progress bar ketika laporan telah selesai di-load
            $("#frame-pembelian-rekap-report").on("load", function() {
                $("#loader").hide();
            });
        }
    </script>
