  ...
  <table class="table table-bordered" cellspacing="1" style="background-color: #333; border: 0px solid #000">
      <thead>
          <tr style="background-color: #fff">
              <th style="text-align: left;padding: 2px 5px;">No. Transaksi</th>
              <th style="text-align: left;padding: 2px 5px;">Tanggal</th>
              <th style="text-align: left;padding: 2px 5px;">Kode Pel.</th>
              <th style="text-align: left;padding: 2px 5px;">Nama Pelanggan</th>
              <th style="text-align: right;padding: 2px 5px;">Sub Total</th>
              <th style="text-align: right;padding: 2px 5px;">Total Pokok</th>
              <th style="text-align: right;padding: 2px 5px;">Laba Kotor</th>
              <th style="text-align: right;padding: 2px 5px;">Potongan</th>
              <th style="text-align: right;padding: 2px 5px;">Laba Jual</th>
          </tr>
      </thead>
      <tbody>');
...
foreach ($body as $l) {
  $pdf->WriteHTML('
          <tr style="background-color: #fff">
              ...
              <td style="padding: 2px 5px;">' . $l["pelanggan_number_formatted"] . '</td>
              <td style="padding: 2px 5px;">' . $l["pelanggan_nama"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["sub_total"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["total_pokok"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["laba_kotor"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["potongan"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["laba_jual"] . '</td>
          </tr>
        ');
...
$pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 4px 5px;" colspan="9"></td>
          </tr>
        ');

$pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 2px 5px;" colspan="4">Total Keseluruhan</td>
              <td style="padding: 2px 5px; text-align: right">' . $footer["sub_total"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $footer["total_pokok"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $footer["total_laba_kotor"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $footer["total_potongan"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $footer["total_laba_jual"] . '</td>
          </tr>
        ');
