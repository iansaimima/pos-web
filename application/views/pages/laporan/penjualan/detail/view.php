...
if (!$allow_laporan_penjualan_detail) {
  ...
  <table width="100%" cellspacing="0">
      <thead>
          <tr style="background-color: #fff">
              ...
              <th style="text-align: left;padding: 2px 5px; border-top: 1px solid #333; border-bottom: 1px solid #333; width: 90px">Kode Pel.</th>
              <th style="text-align: left;padding: 2px 5px; border-top: 1px solid #333; border-bottom: 1px solid #333;">Pelanggan</th>
              <th style="text-align: left;padding: 2px 5px; border-top: 1px solid #333; border-bottom: 1px solid #333;">Alamat</th>
          </tr>
      </thead>
      <tbody>');

foreach ($body as $penjualan_id => $l) {
    $detail_list = $body[$penjualan_id]["details"];
    $detail_footer = $body[$penjualan_id]["footer"];
    $pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 2px 5px;">' . $l["no_penjualan"] . '</td>
              ...
              <td style="padding: 2px 5px;">' . $l["pelanggan_alamat"] . '</td>
          </tr>
        ');
        ...
        foreach($detail_list as $d){
          ...
          $pdf->WriteHTML("
                <tr>
                  ...
                  <td style='font-size: 8pt; text-align: right; width: 70px'>" . $d["harga_jual_satuan"] . "</td>
