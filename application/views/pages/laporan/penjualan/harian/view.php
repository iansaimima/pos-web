...
if (!$allow_laporan_penjualan_harian) {
  ...
  <table class="table table-bordered" cellspacing="1" style="background-color: #333; border: 0px solid #000">
      <thead>
          <tr style="background-color: #fff">
              ...
              <th style="text-align: right;padding: 2px 5px;">Jml. Trs.</th>
              <th style="text-align: right;padding: 2px 5px;">Tot. Trs.</th>
              <th style="text-align: right;padding: 2px 5px;">Jml. Bayar Tunai</th>
              <th style="text-align: right;padding: 2px 5px;">Jml. Bayar Non Tunai</th>
          </tr>
      </thead>
      <tbody>');
...
foreach ($body as $l) {
    $pdf->WriteHTML('
          <tr style="background-color: #fff">
              ...
              <td style="padding: 2px 5px; width: 120px; text-align: right">' . $l["jumlah_transaksi"] . '</td>
              <td style="padding: 2px 5px; width: 120px; text-align: right">' . $l["total_transaksi"] . '</td>
              <td style="padding: 2px 5px; width: 150px; text-align: right">' . $l["jumlah_bayar_tunai"] . '</td>
              <td style="padding: 2px 5px; width: 180px; text-align: right">' . $l["jumlah_bayar_non_tunai"] . '</td>
          </tr>
        ');
...
$pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 4px 5px;" colspan="5"></td>
          </tr>
        ');

$pdf->WriteHTML('
          <tr style="background-color: #fff">
              <td style="padding: 2px 5px; font-weight:bold;">Total</td>
              <td style="padding: 2px 5px; font-weight:bold; text-align: right">' . $footer["total_jumlah_transaksi"] . '</td>
              <td style="padding: 2px 5px; font-weight:bold; text-align: right">' . $footer["grand_total_transaksi"] . '</td>
              <td style="padding: 2px 5px; font-weight:bold; text-align: right">' . $footer["total_jumlah_bayar_tunai"] . '</td>
              <td style="padding: 2px 5px; font-weight:bold; text-align: right">' . $footer["total_jumlah_bayar_non_tunai"] . '</td>
          </tr>
        ');
