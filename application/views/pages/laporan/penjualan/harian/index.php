                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body pt-0" style="margin: 0">
                                <form onsubmit="return false" class="form-horizontal" id="form-penjualan-harian-report">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="gudang_uuid" id="gudang-uuid" class="form-control single-select2">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header border-0 pb-1">
                                <h1 class="card-title"><span id="judul-laporan">Laporan Penjualan Harian</span></h1>
                            </div>
                            <div class="card-body p-3 pt-3" style="margin: 0">
                                <iframe class="iframe-rounded" id="frame-penjualan-harian-report" src="about:blank" frameborder="0" style="width: 100%; height: calc(100vh - 210px)"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function setJudulLaporan(title) {
            if (title == "summary") $("#judul-laporan").html("Laporan harian penjualan");
            if (title == "harian") $("#judul-laporan").html("Laporan harian penjualan");
        }
        ...
        function showReport() {
            ...
            // load report
            $("#frame-penjualan-harian-report").attr('src', "<?= base_url("admin/laporan/penjualan/harian_view") ?>?" + params.join("&"));

            // hilangkan progress bar ketika laporan telah selesai di-load
            $("#frame-penjualan-harian-report").on("load", function() {
                $("#loader").hide();
            });
        }
    </script>
