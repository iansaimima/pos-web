                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body pt-0" style="margin: 0">
                                <form onsubmit="return false" class="form-horizontal" id="form-alur-kas-report">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header border-0 pb-1">
                                <h5 class="card-title"><span id="judul-laporan">Laporan Alur Kas</span></h5>
                            </div>
                            <div class="card-body p-3 pt-3" style="margin: 0">
                                <iframe class="iframe-rounded" id="frame-alur-kas-report" src="about:blank" frameborder="0" style="width: 100%; height: calc(100vh - 210px)"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function showReport() {
            ...
            // load report
            $("#frame-alur-kas-report").attr('src', "<?= base_url("admin/laporan/alur_kas/view") ?>?" + params.join("&"));

            // hilangkan progress bar ketika laporan telah selesai di-load
            $("#frame-alur-kas-report").on("load", function() {
                $("#loader").hide();
            });
        }
    </script>
