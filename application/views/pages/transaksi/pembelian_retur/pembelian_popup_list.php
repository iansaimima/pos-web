                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="padding: 2px">
                                            <!-- No. Pembelian -->
                                            <input data-column="" type="text" class="search-input-text form-control input-sm" placeholder="Cari ..." />
                                        </td>
                                        <td style="padding: 2px">
                                            <!-- No. Nota Pemasok -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/pembelian_retur/ajax_pembelian_list') ?>",
                    "type": "GET",
                ...
                "columnDefs": [{
                        ...
                        render: function(data, type, row) {
                            ...
                            html.push(data.no + " &nbsp; <a href='javascript:void(0);' style='margin-bottom:2px;margin-right:2px' data-toggle='tooltip' title='Edit' class='btn btn-xs btn-primary' onclick=\"returnValue('" + data.number_formatted + "')\"> <i class='fa fa-check'></i> </a>");
        ...
        function returnValue(choice) {
            opener.setSearchResultPembelian(targetField, choice);
            window.close();
        }
    </script>