...
$allow_create = isset($privilege_list["allow_transaksi_pembelian_retur_create"]) ? $privilege_list["allow_transaksi_pembelian_retur_create"] : 0;
$allow_update = isset($privilege_list["allow_transaksi_pembelian_retur_update"]) ? $privilege_list["allow_transaksi_pembelian_retur_update"] : 0;
$allow_delete = isset($privilege_list["allow_transaksi_pembelian_retur_delete"]) ? $privilege_list["allow_transaksi_pembelian_retur_delete"] : 0;
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <h5 class="card-title">Daftar Retur Pembelian</h5>
                                    ...
                                    <table id="datatable" class="table table-striped table-dashboard-two mg-b-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 160px">No. Pembelian</th>
                                                <th>Tanggal</th>
                                                <th>Kode Pemasok</th>
                                                <th>Nama</th>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function initTable() {
            ...
            if (!$.fn.DataTable.isDataTable("#datatable")) {
                table = $("#datatable").DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url($uri_1 . '/pembelian_retur/ajax_list') ?>/" + gudangUuid,
                        "type": "GET",
                    ...
                    "columns": [{
                        ...
                        {
                            "data": "pembelian_number_formatted"
                        }, // col-2
                        {
                            "data": "tanggal"
                        }, // col-3
                ...
                table.ajax.url("<?= base_url($uri_1 . '/pembelian_retur/ajax_list') ?>/" + gudangUuid).draw('page');
            }
        ...
        function load_detail(uuid) {
            ajax_get(
                '<?= base_url("admin/pembelian_retur/ajax_detail") ?>/' + uuid, {},
                function(resp) {
