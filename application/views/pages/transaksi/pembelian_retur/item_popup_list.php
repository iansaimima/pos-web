...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        var table;
        var _pembelianUuid = '<?= get('pembelian_uuid') ?>';
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('admin/pembelian_retur/ajax_item_list/') ?>" + _pembelianUuid,
                    "type": "GET",
                ...
                "columnDefs": [{
                    ...
                    render: function(data, type, row) {
                        ...
                        html.push(data.no + " &nbsp; <a href='javascript:void(0);' style='margin-bottom:2px;margin-right:2px' data-toggle='tooltip' title='Edit' class='btn btn-xs btn-primary' onclick=\"returnValue('" + data.kode + ":" + data.satuan.toUpperCase() + "')\"> <i class='fa fa-check'></i> </a>");
