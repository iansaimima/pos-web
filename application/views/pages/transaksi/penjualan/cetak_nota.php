  ...
  <table class="table table-bordered" cellspacing="1" style="background-color: #333; border: 0px solid #000">
      <thead>
          <tr style="background-color: #fff">
              ...
              <th style="text-align: right;padding: 2px 5px;">Jumlah</th>
              <th style="text-align: right;padding: 2px 5px;">Satuan</th>
              <th style="text-align: right;padding: 2px 5px;">Harga</th>
              <th style="text-align: right;padding: 2px 5px;">Pot. (%)</th>
              <th style="text-align: right;padding: 2px 5px;">Total</th>
          </tr>
      </thead>
      <tbody>');
...
foreach ($content as $l) {
    $pdf->WriteHTML('
          <tr style="background-color: #fff">
              ...
              <td style="padding: 2px 5px; text-align: right">' . $l["jumlah"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["satuan"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["harga_jual"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["potongan"] . '</td>
              <td style="padding: 2px 5px; text-align: right">' . $l["total"] . '</td>
          </tr>
        ');
        ...
        <td width="200" align="right" valign="top"> 
            ...
            <table>
              <tr>
                ...
                <td align="right" width="100">' . $body["sub_total"] . '</td>
              </tr>
              <tr>
                <td align="right">Potongan : </td>
                <td align="right" width="100">' . $body["potongan"] . '</td>
              </tr>
              <tr>
                <td align="right">Total Akhir : </td>
                <td align="right" width="100">' . $body["total_akhir"] . '</td>
              </tr>');

              if($body["metode_pembayaran"] == "Tunai"){
$pdf->WriteHTML('
              <tr>
                <td align="right">Bayar : </td>
                <td align="right" width="100">' . $body["bayar"] . '</td>
              </tr>');
              }else{
$pdf->WriteHTML('
              <tr>
                <td align="right">Panjar : </td>
                <td align="right" width="100">' . $body["bayar"] . '</td>
              </tr>');
              }
...
$pdf->WriteHTML('
              <tr>
                ...
                <td align="right" width="100">' . $body["kembali"] . '</td>
              </tr>');
              }else{
$pdf->WriteHTML('
              <tr>
                <td align="right">Kredit : </td>
                <td align="right" width="100">' . $body["sisa"] . '</td>
              </tr>
              <tr>
                <td align="right">Jatuh Tempo : </td>
                <td align="right" width="100">' . $body["tanggal_jatuh_tempo"] . '</td>
              </tr>
              ');
