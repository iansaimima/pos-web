...
$gudang_uuid = isset($cabang_selected["transaksi_penjualan_default_gudang_uuid"]) ? $cabang_selected["transaksi_penjualan_default_gudang_uuid"] : "";
?>
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="modal fade" id="modal-pelunasan" style="padding: 0 !important; background-color: #ececec;">
            <div class="modal-dialog modal-dialog-centered " style="width: 100%;margin: 0; max-width: none; height: 100%" role="document">
                <div class="modal-content" id="modal-pelunasan-content" style="box-shadow: none !important; height: 100%; border-radius: 0; border: none; background-color: #ececec;">
    ...
    ***********************************-->
    ...
    <script>
        ...
        function initTable() {
            ...
            if (!$.fn.DataTable.isDataTable("#datatable")) {
                table = $("#datatable").DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url($uri_1 . '/penjualan/ajax_list') ?>/" + gudangUuid,
                        "type": "GET",
                ...
                table.ajax.url("<?= base_url($uri_1 . '/penjualan/ajax_list') ?>/" + gudangUuid).draw('page');
            }
        }

        function load_detail(uuid) {
            ajax_get(
                '<?= base_url($uri_1 . "/penjualan/ajax_detail") ?>/' + uuid, {},
                function(resp) {
        ...
        function load_pelunasan() {
            ajax_get(
                '<?= base_url($uri_1 . '/penjualan/ajax_pelunasan/') ?>', {},
                function(resp) {
                    $("#modal-pelunasan-content").html(resp);
